...
local aa = {
    function()
        ...
        function x.Notify(C, D)
            return x.ShowNotifications and t:New(D) or {}
        end
        if getgenv then
            getgenv().Fluent = x
        end
                     ...
                     then
                        if
                            M.KeyCode.Name == u.MinimizeKeybind.Value or
                                u.MinimizeKeybind.Value == "RMB" and M.UserInputType == Enum.UserInputType.MouseButton2
                         then
                            v:Minimize()
                        end
                    elseif
    ...
    [47] = function()
        ...
        local af = {Names = {"Dark", "Darker", "Purple", "Aqua", "Amethyst", "Rose"}}
    ...
    [52] = function()
        ...
        return {
            ...
            ToggleToggled = Color3.fromRGB(105, 0, 255),
